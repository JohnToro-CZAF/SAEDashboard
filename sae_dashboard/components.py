...
class SequenceData:
    ...
    def _get_html_data(
        ...
        print("bold_idx:", bold_idx)
        print("max_feat_act:", max_feat_act)
        ...
        if only_bold:
            ...
            # print("pos_ids:", self.top_token_ids)
            # print("neg_ids:", self.bottom_token_ids)
            # print("pos_val:", self.top_logits)
            # print("neg_val:", self.bottom_logits)
        ...
        # print("bold_idx:", bold_idx)
        # print("feat_acts:", feat_acts)
        # print("len(pos_ids):", len(pos_ids))
        # print("len(token_ids):", len(self.token_ids))
